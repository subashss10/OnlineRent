<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditPostDetails.aspx.cs" Inherits="OnlineRent.EditPostDetails" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            <div class="jumbotron">
                ...
                <br />
                <br />
                <asp:Button ID="btnUpdate" class="btn btn-primary" runat="server" Text="Update Details" OnClick="btnUpdate_Click1"  />
